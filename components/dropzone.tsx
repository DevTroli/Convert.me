    ...
    return (
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          <div
            key={i}
            className="w-full py-4 space-y-4 lg:py-0 relative cursor-pointer rounded-xl border h-fit lg:h-20 px-4 lg:px-10 flex flex-wrap lg:flex-nowrap items-center justify-between"
          >
            {!is_loaded && (
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex items-center gap-1 w-96">
                <span className="text-md text-white font-medium overflow-x-hidden">
            ...
            {action.is_error ? (
              <Badge variant="destructive" className="flex gap-2">
                <span>Error Convertion File</span>
                <BiError />
              </Badge>
            ) : action.is_converted ? (
              ...
              <div className="text-white/80 text-md flex items-center gap-4">
          ...
          {is_done ? (
            <div className="space-y-4 w-fit">
              ...
              <Button
                ...
                onClick={reset}
                variant="ghost"
                className="rounded-xl text-white bg-transparent border">
            ...
            >
              {is_converting ? (
                <span className="animate-spin text-md">
                  <ImSpinner3 />
                </span>
              ) : (
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" bg-gray-800/40 h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
